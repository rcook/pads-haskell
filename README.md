# pads-haskell [![Travis build](https://img.shields.io/travis/rcook/pads-haskell/p-rcook-travis-ci.svg?label=Linux%20build)](https://travis-ci.org/rcook/pads-haskell)
